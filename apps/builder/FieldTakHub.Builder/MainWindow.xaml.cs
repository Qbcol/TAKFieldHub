...
public partial class MainWindow : Window
{
    ...
    private void ConfigureResponsiveWindow()
    {
        ...
        var targetWidth = Math.Min(1280, work.Width * 0.90);
        var targetHeight = Math.Min(760, work.Height * 0.88);
    ...
    private void MeshtasticToUi(MeshtasticProfile m)
    {
        ...
        MeshtasticDeviceRoleBox.SelectedIndex = m.DeviceRole switch { "field_node" => 1, "gateway" => 2, _ => 0 };
    ...
    private void MeshtasticDeviceRoleBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        else if (role == "field_node") MeshtasticGatewayEnabledBox.IsChecked = false;
    }
    ...
    {
        if (!_uiReady || BuilderModeBox is null || AdvancedFoldersPanel is null || AdvancedMeshtasticPanel is null || AdvancedGatewayPanel is null || AdvancedEnrollmentPanel is null || AdvancedSecurityPanel is null || AdvancedModeHint is null)
            return;
