...
public sealed class UpdateService
{
    ...
    public UpdateService()
    {
        ...
        var repo = "Qbcol/field-tak-hub"; var channel = "rc";
        ...
        _http.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("FieldTAKHubBuilder", "2.1.0-rc3"));
    ...
    public async Task<BuilderUpdateInfo?> CheckAsync(CancellationToken ct = default)
    {
        ...
        if (CompareVersions(version, "2.1.0-rc3") <= 0) return null;
