...
6. Push the annotated RC tag `v2.0.1-rc3-builder-2.1.0-rc5`.
...
If your repository is not `Qbcol/TAKFieldHub`, update the updater repository setting before making a release.
